...
<?php include("includes/head.php"); ?>
	<body>
						...
						<div class="content-page-header">
							...
							<div class="list-btn">
								<ul class="filter-list">
									...
									<li>
			<a class="btn btn-primary" href="add-customer.php"><i class="fa fa-plus-circle me-2" aria-hidden="true"></i>Add Customer</a>
									</li>
								</ul>
							</div>
						</div>
		...
		<a class="dropdown-item" href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#delete_modal"><i class="far fa-trash-alt me-2"></i>Delete</a>
			...
			<li>
				<a class="dropdown-item" href="customer-details.php?id=<?php  echo $customer['id'] ?>"><i class="far fa-eye me-2"></i>View</a>
			</li>
			<li>
...
<!-- Mirrored from kanakku.dreamstechnologies.com/html/template/customers.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 07 Feb 2024 11:49:20 GMT -->
</html>