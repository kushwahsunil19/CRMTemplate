						...
						<div class="content-page-header">
							...
							<div class="list-btn">
								<ul class="filter-list">
									...
									<li>
			<a class="btn btn-primary" href="add_leads.php"><i class="fa fa-plus-circle me-2" aria-hidden="true"></i>Add Leads</a>
									</li>
								</ul>
							</div>
						</div>
            ...
            <?php if (!empty($leads)): ?>
                <?php foreach ($leads as $index => $lead): ?>
                    <tr>
                        ...
                        <td><?= htmlspecialchars($lead['lead_status']) ?></td>
