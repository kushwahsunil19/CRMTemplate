...
<?php include("includes/head.php"); ?>
						...
						<div class="content-page-header">
							...
							<div class="list-btn">
								<ul class="filter-list">
									...
									<li>
										<a class="btn btn-import" href="javascript:void(0);"><span><i class="fe fe-check-square me-2"></i>Import Leads</span></a>
									</li>
									<li>
			<a class="btn btn-primary" href="add_followup.php"><i class="fa fa-plus-circle me-2" aria-hidden="true"></i>Add Follow-Up</a>
									</li>
								</ul>
							</div>
						</div>
    ...
    <tbody>
        <?php include 'fetch_followup.php'; ?>
        <?php if (!empty($followups)): ?>
            <?php foreach ($followups as $index => $followup): ?>
                <tr>
                    <td><?= $index + 1 ?></td>
                    <td><?= htmlspecialchars($followup['lead_full_name']) ?></td>
                    <!-- Fetch and display lead name from leads table based on lead_id -->
                    <td><?= htmlspecialchars($followup['follow_up_date']) ?></td>
                    <td><?= htmlspecialchars($followup['follow_up_method']) ?></td>
                    <td><?= htmlspecialchars($followup['sales_rep_full_name']) ?></td>
                    <td><?= $followup['reminder_sent'] ? 'Yes' : 'No' ?></td>
                    ...
                    <div class="dropdown dropdown-action">
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            <ul>
                                <li>
                                    <a class="dropdown-item" href="edit-lead.html"><i class="far fa-edit me-2"></i>Edit</a>
                                </li>
                                <li>
                                ...
                                <li>
                                    <a class="dropdown-item" href="lead-details.php?id=<?= $lead['lead_id'] ?>"><i class="far fa-eye me-2"></i>View</a>
                                </li>
                                <li>
                                    <a class="dropdown-item" href="active-leads.html"><i class="fa-solid fa-power-off me-2"></i>Activate</a>
                                </li>
                                <li>
                                    <a class="dropdown-item" href="deactive-leads.html"><i class="far fa-bell-slash me-2"></i>Deactivate</a>
                                </li>
                            </ul>
                        </div>
                    </div>
        ...
        <?php else: ?>
            <tr>
                <td colspan="7" class="text-center">No follow-up  found.</td>
            </tr>
        <?php endif; ?>
    </tbody>
</table>
