...
<?php include("includes/head.php"); ?>
						...
						<div class="content-page-header">
							...
							<div class="list-btn">
								<ul class="filter-list">
									...
									<li>
			<a class="btn btn-primary" href="add_salesrepresentative.php"><i class="fa fa-plus-circle me-2" aria-hidden="true"></i>Add Sales Representative</a>
									</li>
								</ul>
							</div>
						</div>
    ...
    <tbody>
        <?php include 'fetch_salesrep.php'; ?>
        ...
        <?php if (!empty($sales_reps)): ?>
            <?php foreach ($sales_reps as $index => $rep): ?>
                <tr>
                    ...
                    <td><?= htmlspecialchars($rep['phone_number']) ?></td>
        ...
        <?php else: ?>
            <tr>
                <td colspan="6" class="text-center">No sales representatives found.</td>
            </tr>
        <?php endif; ?>
    </tbody>
</table>
