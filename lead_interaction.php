...
<?php include("includes/head.php"); ?>
						...
						<div class="content-page-header">
							...
							<div class="list-btn">
								<ul class="filter-list">
									...
									<li>
			<a class="btn btn-primary" href="add_leadinteraction.php"><i class="fa fa-plus-circle me-2" aria-hidden="true"></i>Add LeadInteraction</a>
									</li>
								</ul>
							</div>
						</div>
    ...
    <tbody>
        <?php include 'fetch_interactions.php';
...
<td><?= htmlspecialchars($interaction['full_name']) ?></td>
                    ...
                    <td><?= htmlspecialchars($interaction['next_steps']) ?></td>
