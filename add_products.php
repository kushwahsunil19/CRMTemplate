                 ...
                 <div class="align-center">
                    <div class="form-control me-3">
                        <label class="custom_radio me-3 mb-0">
                            <input type="radio" class="form-control" name="item_type" value="product" id="item_type_product" checked>
                            <span class="checkmark"></span> Product
                        </label>
                     </div>
                     <div class="form-control">
                        <label class="custom_radio mb-0">
                            <input type="radio" name="item_type" id="item_type_service" value="service">
        ...
        <div class="row">
            <div class="col-xl-12 col-lg-12 col-md-12 col-12">
                <div class="input-block mb-3" id="summernote_container">
                    ...
                    <textarea class="summernote form-control" id="product_description" name="product_description" placeholder="Type your message"></textarea>
                </div>
            </div>
