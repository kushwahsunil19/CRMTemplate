				...
				<div class="content container-fluid">
					<div class="card mb-0">
						<div class="card-body">
							...
							<div class="row">
								<div class="col-md-12">
	<form id="lead-conversion-form" method="POST" enctype="multipart/form-data">
    <div class="form-group-item">
        <h5 class="form-title">Lead Conversion Details</h5>
        <div class="row">
            <div class="col-lg-6 col-md-12">
                <div class="input-block mb-3">
                    <label for="lead_id">Lead ID <span class="text-danger">*</span></label>
                    <input type="text" id="lead_id" name="lead_id" class="form-control" required>
                </div>
            </div>
            <div class="col-lg-6 col-md-12">
                <div class="input-block mb-3">
                    <label for="conversion_date">Conversion Date <span class="text-danger">*</span></label>
                    <input type="datetime-local" id="conversion_date" name="conversion_date" class="form-control" required>
                </div>
            </div>
            <div class="col-lg-12 col-md-12">
                <div class="input-block mb-3">
                    <label for="conversion_notes">Conversion Notes</label>
                    <textarea id="conversion_notes" name="conversion_notes" class="form-control" placeholder="Enter Conversion Notes"></textarea>
                </div>
            </div>
        </div>
    </div>
    <div class="add-conversion-btns text-end">
        <button type="submit" class="btn conversion-btn-save">Add Conversion</button>
        <button type="button" class="btn conversion-btn-cancel">Cancel</button>
    </div>
</form>
...
$(document).ready(function() {
    $('#lead-conversion-form').submit(function(e) {
