						...
						<div class="card-body">
							...
							<div class="page-header">
								<div class="content-page-header">
									<h5>Add Leads interaction</h5>
								</div>	
							</div>
							<!-- /Page Header -->				
							<div class="row">
								<div class="col-md-12">
<form id="lead-interaction-form" enctype="multipart/form-data">
    <div class="form-group-item">
        <h5 class="form-title">Lead Interaction Details</h5>
        <div class="row">
    ...
    <select id="lead_id" name="lead_id" class="form-control" required>
        ...
        ?>
            ...
            <div class="col-lg-4 col-md-6 col-sm-12">
                <div class="input-block mb-3">
                    <label for="interaction_type">Interaction Type <span class="text-danger">*</span></label>
            ...
            <div class="col-lg-4 col-md-6 col-sm-12">
                <div class="input-block mb-3">
                    <label for="interaction_date">Date <span class="text-danger">*</span></label>
                    <input type="datetime-local" id="interaction_date" name="interaction_date" class="form-control" required>
                </div>
            </div>
            <div class="col-lg-8 col-md-12 col-sm-12">
                <div class="input-block mb-3">
                    <label for="notes">Notes</label>
                    <textarea id="notes" name="notes" class="form-control" placeholder="Enter Interaction Notes"></textarea>
                </div>
            </div>
            <div class="col-lg-8 col-md-12 col-sm-12">
                <div class="input-block mb-3">
                    <label for="next_steps">Next Steps</label>
                    <textarea id="next_steps" name="next_steps" class="form-control" placeholder="Enter Next Steps"></textarea>
                </div>
            </div>
        </div>
    </div>
    <div class="add-interaction-btns text-end">
        <button type="submit" class="btn interaction-btn-save">Log Interaction</button>
        <button type="button" class="btn interaction-btn-cancel">Cancel</button>
    </div>
</form>
...
$(document).ready(function() {
     $('#lead-interaction-form').submit(function(e) {
